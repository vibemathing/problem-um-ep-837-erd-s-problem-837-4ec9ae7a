...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-837-erd-s-problem-837-4ec9ae7a-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-837"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-837-erd-s-problem-837-4ec9ae7a-v1",
      "problem_contract_sha256": "90f64c16024289d961619dc3167e985a78b1209855113cb4066b8d9f8c1fd64e",
      "problem_id": "problem:um-ep-837-erd-s-problem-837-4ec9ae7a",
      "route_id": "route:um-ep-837-erd-s-problem-837-4ec9ae7a-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-837-erd-s-problem-837-4ec9ae7a-source-fidelity-01",
      "graph_id": "graph:um-ep-837-erd-s-problem-837-4ec9ae7a-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-837-erd-s-problem-837-4ec9ae7a-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-837-erd-s-problem-837-4ec9ae7a-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $k\\geq 2$ and $A_k\\subseteq [0,1]$ be the set of $\\alpha$ such that there exists some $\\beta(\\alpha)>\\alpha$ with the property that, if $G_1,G_2,\\ldots$ is a sequence of $k$-uniform hypergraphs with $ \\liminf \\frac{e(G_n)}{\\binom{\\lvert G_n\\rvert}{k}} >\\alpha $ then there exist subgraphs $H_n\\subseteq G_n$ such that $\\lvert H_n\\rvert \\to \\infty$ and $ \\liminf \\frac{e(H_n)}{\\binom{\\lvert H_n\\rvert}{k}} >\\beta, $ and further that this property does not necessarily hold if $>\\alpha$ is replaced by $\\geq \\alpha$. What is $A_3$?"
          },
          "statement_sha256": "6cfd60a8d4fcc8f15d50afe03fc42cebdff1f4a731d0cc3af7829eafbfbdf889"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-837-erd-s-problem-837-4ec9ae7a-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-837-erd-s-problem-837-4ec9ae7a-root",
      "route_id": "route:um-ep-837-erd-s-problem-837-4ec9ae7a-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-837-92281899d990",
        "url": "https://www.unsolvedmath.com/problems/EP-837"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
